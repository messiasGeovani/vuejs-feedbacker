    ...
    <form @submit.prevent="handleSubmit">
      <label class="block">
        ...
        <input
          ...
          type="text"
          :class="{
            'border-brand-darger': !!state.name.errorMessage
          }"
      ...
      <label class="block mt-9">
        ...
        <input
          ...
          type="email"
          :class="{
            'border-brand-darger': !!state.email.errorMessage
          }"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
      ...
      <label class="block mt-9">
        ...
        <input
          ...
          type="password"
          :class="{
            'border-brand-darger': !!state.password.errorMessage
          }"
          class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded"
          placeholder="jonh.doe@email.com"
        />
