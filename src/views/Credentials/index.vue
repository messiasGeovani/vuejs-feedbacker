  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      >
        ...
        <div class="flex ml-20 mr-2" v-if="!state.hasError">
          <icon
            @click="handleCopy"
            name="copy"
      ...
      <div
        v-else
        class="py-3 pl-5 pr-20 mt-2 rounded bd-brand-gray w-full lg:w-2/3 overflow-x-scroll"
      >
        <span v-if="state.hasError">Erro ao carregar o script</span>
        <!-- prettier-ignore -->
        <pre v-else>&lt;script src="https://messiasGeovani-feedbacker-widget.netlify.app?apiKey={{ store.User.currentUser.apiKey }}"&gt;&lt;/script&gt;</pre>
      </div>
    </div>
  </div>
</template>
